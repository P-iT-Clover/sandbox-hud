...
HUD = {
	...
	-- ShowLocation function sets showing the compass at the top of the screen
	-- @setShowing boolean set showing
	ShowLocation = function(self, setShowing)
